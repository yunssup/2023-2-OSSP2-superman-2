...
function SearchResult(){
    ...
    useEffect(() => {
        axios.get(`http://localhost:8080/api/region?userid=${selectedOptions.userId}&regionid=${parseInt(selectedOptions.select1)}&condition=${parseInt(selectedOptions.select2)}&range=${parseInt(selectedOptions.select3)}&maxtraval=${parseInt(selectedOptions.select4)}`)
        .then(response => {
                ...
                <ResultGroup>
                    <ResultPara>
                        ...
                        <ResultDiv>
                            ...
                            <ResultValue id='resultTransportCost'>{fetchedData.transportcost}</ResultValue>
                        </ResultDiv>
                    </ResultPara>
                </ResultGroup>
                <NavBarRow>
